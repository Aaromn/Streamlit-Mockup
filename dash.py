...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    reports = [
        {
            ...
            "region": "All Regions",
            "status": "New",
            "summary": "Nation units reached 310 — a strong rebound from the prior week. Alpha region continues to lead short-term growth.",
            "insights": [
                ("positive", "✅ Alpha region exceeded weekly unit goal by 7.6% (127 vs. 118 target)."),
                ("positive", "✅ Nation C13W/P13W growth held steady at +2.1% for the third consecutive week."),
                ("negative", "⚠️ Gamma PEQ Call Adherence dropped to 29.7% — below the 30% threshold."),
                ("negative", "⚠️ Beta region projected attainment fell to 102.4%, narrowing the buffer."),
                ("neutral",  "ℹ️ Unassigned Region avg HCP calls/day increased to 5.7 — monitor for territory assignment."),
            ],
            "top_performers": ["L. Ipsum (Alpha) — 19 units", "D. Lorem (Alpha) — 16 units", "S. Amet (Beta) — 15 units"],
            "action_items": ["Follow up with Gamma reps on PEQ adherence protocol.", "Review Beta territory goal calibration for Q3."],
        },
        {
            ...
            "region": "All Regions",
            "status": "Viewed",
            "summary": "Unit output dipped to 272 nationally. Beta and Gamma underperformed vs. prior week.",
            "insights": [
                ("negative", "⚠️ Nation weekly units down 15% vs. prior week (272 vs. 321)."),
                ("negative", "⚠️ Beta C26W/P26W growth turned negative at -1.7%."),
                ("positive", "✅ Alpha maintained strong HCP reach with 412 HCPs contacted."),
                ("neutral",  "ℹ️ Total emails sent nationally dropped by 10% — verify CRM sync."),
                ("positive", "✅ Gamma C52W/P52W growth remains strong at +10.3%."),
            ],
            "top_performers": ["C. Dolor (Gamma) — 17 units", "L. Ipsum (Alpha) — 15 units", "A. Consec (Beta) — 12 units"],
            "action_items": ["Investigate Beta region growth decline — schedule regional call.", "Audit CRM email sync for missing records."],
        },
        {
            ...
            "region": "All Regions",
            "status": "Viewed",
            "summary": "Best performing week in Q2 — 321 units nationally. Projected attainment on track at 99.5%.",
            "insights": [
                ("positive", "✅ Nation units reached 321 — highest single-week output this quarter."),
                ("positive", "✅ Alpha projected attainment at 101.5%, surpassing quarterly goal."),
                ("positive", "✅ Beta region rebounded with 105 units after two consecutive down weeks."),
                ("neutral",  "ℹ️ PEQ Call Adherence nationally at 33.5% — above the 30% floor."),
                ("negative", "⚠️ Gamma run rate (91.3) remains the lowest across all regions."),
            ],
            "top_performers": ["D. Lorem (Alpha) — 20 units", "S. Amet (Beta) — 18 units", "L. Ipsum (Alpha) — 17 units"],
            "action_items": ["Recognize top Alpha performers in weekly all-hands.", "Coach Gamma reps on run rate improvement strategies."],
        },
        {
            ...
            "region": "All Regions",
            "status": "Viewed",
            "summary": "Moderate week nationally at 278 units. HCP reach remains consistent across all regions.",
            "insights": [
                ("neutral",  "ℹ️ Nation units at 278 — 4% below prior week but within seasonal norms."),
                ("positive", "✅ HCPs Reached nationally at 1,532 — consistent with 13-week average."),
                ("negative", "⚠️ Calls by Initiators declined 5% week-over-week (478 vs. 503)."),
                ("positive", "✅ Alpha C13W growth at 6.3% — strongest region for short-term growth."),
                ("neutral",  "ℹ️ Gamma email volume (1,512) highest of all regions — strong digital engagement."),
            ],
            "top_performers": ["L. Ipsum (Alpha) — 16 units", "C. Dolor (Gamma) — 15 units", "A. Consec (Beta) — 14 units"],
            "action_items": ["Analyze initiator call decline — identify reps below threshold.", "Share Gamma email best practices cross-regionally."],
        },
        {
            ...
            "region": "All Regions",
            "status": "Viewed",
            "summary": "Strong rebound week — 322 units. Alpha and Beta both outperformed weekly targets.",
            "insights": [
                ("positive", "✅ Nation units at 322 — up 18% vs. prior week (273)."),
                ("positive", "✅ Beta region units at 98 — highest in 6 weeks."),
                ("positive", "✅ Beta projected attainment climbed to 105.6% for the first time this quarter."),
                ("negative", "⚠️ Gamma PEQ adherence at 33.8% — only marginally above threshold."),
                ("neutral",  "ℹ️ Avg HCP Calls/Day nationally stable at 1.4."),
            ],
            "top_performers": ["S. Amet (Beta) — 21 units", "D. Lorem (Alpha) — 18 units", "L. Ipsum (Alpha) — 17 units"],
            "action_items": ["Replicate Beta region strategies in Gamma.", "Set stretch goals for Alpha reps nearing quota ceiling."],
        },
        {
            ...
            "region": "All Regions",
            "status": "Viewed",
            "summary": "Slowest week of the quarter at 264 units. Multiple regions flagged for follow-up.",
            "insights": [
                ("negative", "⚠️ Nation units at 264 — lowest of the quarter, likely due to holiday impact."),
                ("negative", "⚠️ Beta region C26W growth turned negative at -1.7%."),
                ("negative", "⚠️ Calls by Initiators at 478 — declined for second consecutive week."),
                ("neutral",  "ℹ️ Alpha maintained relative stability at 99 units despite national dip."),
                ("positive", "✅ Email engagement remained high across all regions."),
            ],
            "top_performers": ["L. Ipsum (Alpha) — 14 units", "C. Dolor (Gamma) — 13 units", "A. Consec (Beta) — 11 units"],
            "action_items": ["Account for holiday week in monthly reporting.", "Schedule call with Beta regional manager to address growth trend."],
        },
    ]
    ...
    with nc1:
        ...
        <div style="background:white; border:1px solid #ddd; border-radius:8px; padding:12px 16px; text-align:center;">
            ...
            <div style="font-size:18px; font-weight:700; color:#1a3a6b; margin-top:4px;">Mon, Jul 14, 2025</div>
    ...
    with nc2:
        ...
        <div style="background:white; border:1px solid #ddd; border-radius:8px; padding:12px 16px; text-align:center;">
            ...
            <div style="font-size:18px; font-weight:700; color:#1a3a6b; margin-top:4px;">12 Sales Managers</div>
    ...
    with nc3:
        ...
        <div style="background:white; border:1px solid #ddd; border-radius:8px; padding:12px 16px; text-align:center;">
            ...
            <div style="font-size:12px; color:#666;">Since Apr 18, 2025</div>
        </div>""", unsafe_allow_html=True)
    st.markdown("<br>", unsafe_allow_html=True)

    # ── Filters ───────────────────────────────────────────────────────────────
    fc1, fc2, fc3, _ = st.columns([1.5, 1.5, 1.5, 2])
    with fc1: st.selectbox("Filter by Region", ["All Regions", "Alpha", "Beta", "Gamma"])
    with fc2: st.selectbox("Filter by Status", ["All", "New", "Viewed"])
    with fc3: st.selectbox("Sort by", ["Newest First", "Oldest First"])
    st.markdown("<br>", unsafe_allow_html=True)

    # ── Email metadata (scrambled) ────────────────────────────────────────────
    email_meta = [
        ...
        with st.expander(label, expanded=is_new):
            ...
            with col_left:
                ...
                for kind, text in r["insights"]:
                    color = "#2e7d32" if kind == "positive" else ("#c62828" if kind == "negative" else "#1a3a6b")
            ...
            with col_right:
                ...
                for p in r["top_performers"]:
                    st.markdown(f'<p style="font-size:13px; color:#333; margin:2px 0;">• {p}</p>', unsafe_allow_html=True)
                st.markdown("<br>", unsafe_allow_html=True)
                st.markdown("**📌 Action Items:**")
                for a in r["action_items"]:
                    st.markdown(f'<p style="font-size:13px; color:#c62828; margin:2px 0;">→ {a}</p>', unsafe_allow_html=True)

            st.markdown("---")
            dl1, dl2, _ = st.columns([1.2, 1.2, 4])
            with dl1: st.button("📥 Export PDF",   key=f"pdf_{i}")
            with dl2: st.button("📧 Resend Email", key=f"email_{i}")
